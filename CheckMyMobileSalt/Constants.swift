...
let MappingTable: [String: String?] = [
    ...
    "/EVOCjM/Nmb2roP5ebtEFA": nil, // supports-spatial-facetime
    ...
    "0rbLl0hXmTehfEduXfeJYQ": nil, // X7SF9XDG+CBhoPIXA1YlCg
    ...
    "1qDdT/85SS7sxriK0wIbbg": nil, // MGIOMFBSupport.c
    ...
    "2oKaRZpltNseA9gTdIKTQQ": nil, // eW5H/Gwg0uqbMqFot70pYg
    ...
    "2tBx5IzZX4CpUVJ79LfsVg": nil, // tribeca
    ...
    "5Y72WwdS5NYHdc00gEZ/DQ": nil, // 8DHlxr5ECKhTSL3HmlZQGQ: aqc-a, extlom-mac-address
    ...
    "6WdGcQGw4VLzrgxJo+bcrw": nil, // TF31PAB6aO8KAbPyNKSxKA
    ...
    "7ZipyD32hkjOUTl66Q8REw": nil, // has /usr/libexec/lockdownd(.internal) or not
    ...
    "8bCjks0zVuOcdivIhytNbQ": nil, // QVwCp3Lu9RLnxw7LO9DBfQ
    ...
    "8S7ydMJ4DlCUF38/hI/fJA": nil, // PearlCameraCapability
    "8Shl+AdVKo09f1Sldkb0kA": "touch-id",
    "8Vbp0HyqndjWuIFZibhu7g": nil,
    ...
    "AspYltP/iGWg0qxfg7c/3w": nil, // twodbl
    ...
    "bbtR9jQx50Fv5Af/affNtA": nil, // +VIu65zA5EW4ztayJXvOUg if AppleTV, IODeviceTree:/product, product-name otherwise
    ...
    "byGRtH44VNik9CzN/QKLCw": nil, // SBe5o/DMF5Z94MS+ZzmBCA
    ...
    "DoMjIR2qPkxXtP/kDu/gfQ": nil, // mesa type
    ...
    "eW5H/Gwg0uqbMqFot70pYg": nil, // soc-generation related
    ...
    "eXzS2kvF8nNOI/xIJKquHg": nil, // scandium, /arm-io, InterfaceName
    ...
    "fYsrGTmVTbneEs3HKetEdQ": nil, // IODeviceTree:/product/camera > ItOvlwIhFj2aCXL4wk3ijg
    ...
    "IMUksyctl4kC/BFI2K/Qyw": nil, // IODeviceTree:/product/camera > bmYssgjtQNKMy3Zhf8N+2w
    "inECTnNyR97XWxm7jU8uqA": "MobileEquipmentInfoBaseId",
    "inLiSl5OQHJ1stAIvKH8wg": "RegionalBehaviorGB18030",
    "iTvGxmtSOnHv548XON379A": nil, // mesa type
    ...
    "JWjvsupiqWYtIGwr8yGd8w": nil, // eW5H/Gwg0uqbMqFot70pYg
    ...
    "kT9JwUR2xPCTHTdgvG3UdA": nil, // Af/UTHptqxLPG5sy0wQTiw"
    ...
    "Lg1EJX11Jb7EbveB6+YgVQ": nil, // lwHRTZNO5Jq87pVlzdNGIA (DeviceSupports720p)
    "lHMDJnC58naUz2rOCJyVIw": "IntegratedCircuitCardIdentifier2",
    "li+w2foswFu0srn5UxdOug": nil,
    ...
    "lo3szoQ4sLy7o3+ZD0GcAQ": nil, // primary usage (page)
    ...
    "m7lDS+oP8q0pGg+CO7RvPg": nil, // IODeviceTree:/chosen > 4JalTKSe5a9I+mb00ATvag
    ...
    "Mi/ME+v1wZqkvXFU3xX3KA": nil, // eW5H/Gwg0uqbMqFot70pYg
    ...
    "NDnoY3adyyskgiIQBNtlyQ": nil, // IODeviceTree:/, model-config NED=1
    ...
    "njUcH4bm+JBmvASakDdObg": nil, // IODeviceTree:/arm-io/isp > /4LCTfMhvzuiK6b557ir5Q
    ...
    "PFnuFyqMMnGUQQnTqS5byg": nil, // IODeviceTree:/product > MlDJggkQz38CLQh3AVv7VQ
    ...
    "RNcdWbM8+dO5tx82A+YCcQ": nil, // host UUID
    ...
    "VuGdqp8UBpi9vPWHlPluVQ": nil, // array
    "W/xqvBX9L07XHb0BOtYycQ": nil, // yF2IQrYS4yyREV4ZkbLysw
    "WAfNjeiwOd/k6+VU6D6SIQ": nil, // 5Y72WwdS5NYHdc00gEZ/DQ
    "waGD2UTpntjbDXD1r3oALQ": nil,
    ...
    "X7SF9XDG+CBhoPIXA1YlCg": nil, // 8DHlxr5ECKhTSL3HmlZQGQ, fillmore, local-mac-address
    "X9cK3qXzcFCrVpE258P2lQ": nil, // XcmwH6K+Nop/mDqy50Nrqw
    "Xa9nxhMDoHTdmrn/FufA3g": "WatchSupportsListeningOnGesture",
    "xbNo7dj2oAnz92JhEOn9tw": "DevicePrefers3DBuildingStrokes",
    "XcmwH6K+Nop/mDqy50Nrqw": nil,
    ...
    "XnXl4MhKZx3zRKvA7ZwIYQ": nil, // iPad ? 10 : 20
    ...
    "XYlJKKkj2hztRP1NWWnhlw": nil, // IODeviceTree:/chosen > E3qwwdwgUSy6FV6VC+Uf3A
    ...
    "yF2IQrYS4yyREV4ZkbLysw": nil, // AppleFillmoreDevice, local-mac-address-64
    ...
    "Z06ZMtQY6G3kKrC7fs/gOA": nil, // hSjeLvzobsJCklk4+pzu3g
    ...
    "ZYqko/XM5zD3XBfN5RmaXA": nil, // PiPPinned or IODeviceTree:/product > h9v96tCehBWUil/aJ7UrcA
]
